...
# Networked Data Lab: NDL Grampian satellite project on Clinically Extremely Vulnerable (CEV) people
...
- This is the repository for the NDL Grampian satellite analysis.  
...
This project is licensed under the [MIT License](https://github.com/HFAnalyticsLab/NDL_Output4_Grampian/blob/main/LICENSE).
